    ...
    <main id="main" class="">
        ...
        <section id="" class="wow fadeIn">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-dark rounded ">
                    ...
                    <div class="text-white mx-auto  " id="navbarNavAltMarkup">
                        <div class="navbar-nav ">
                            <a class="nav-item text-white nav-link " href="<?= base_url('home/dashboard'); ?>">Data Tim <span class="sr-only">(current)</span></a>
            ...
            <div class="container my-4">
                ...
                <h6>Status Pembayaran = <font style="color:red"> <?= $team['validasi']; ?></font>
                </h6>
